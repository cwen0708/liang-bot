    ...
    <div class="grid grid-cols-3 gap-6">
      ...
      <div class="col-span-2 space-y-4">
        <div class="bg-(--color-bg-card) border border-(--color-border) rounded-xl p-4">
          ...
          <textarea
            v-model="editJson"
            class="w-full h-[500px] bg-(--color-bg-secondary) border border-(--color-border) rounded-lg p-3 text-sm font-mono resize-none focus:outline-none focus:border-(--color-accent)"
            spellcheck="false"
          />
      ...
      <div class="bg-(--color-bg-card) border border-(--color-border) rounded-xl p-4">
        ...
        <div class="space-y-2 max-h-[580px] overflow-auto">
          <div
